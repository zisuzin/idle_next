...
const headlines = [
    {
        ...
        tit: "6th Mini Album :<br/>Queencard",
        mtit: "Queencard",
    ...
    },
    {
        ...
        tit: "2nd Single Album :<br/>Expectations",
        mtit: "Expectations",
        desc: "영국 출신 글로벌 팝스타 앤 마리(Anne-Marie)와 여자아이들 민니의 콜라보!<br/>‘Expectations’는 '타인의 시선과 기대에 얽매이지 않고 당차게 현재의 삶을 살아가야한다'는 메시지를 전한다.<br/><br/>과거에 나를 평가했던 모든 기준에서 벗어나면서, 궁극적으로는 ‘타인의 기준은 필요 없는 내가 개척하는 나만의 길’이라는 메시지를 담고 있다. 이러한 메시지에 더불어, 앤-마리와 민니의 파워풀하지만 섬세한 보컬이 더해져 전 세계 리스너들의 귀를 한 번에 사로잡는 멜로디와 가사가 돋보이는 곡이다.",
        date: "2023.03.09",
    ...
    },
    {
        ...
        tit: "Steve Aoki Remix<br/>X (G)IDLe : Nxde",
        mtit: "Nxde",
        desc: "내가 사랑하는 나의 본모습, 'Nxde' 디지털 싱글 발매!<br/>누드가 그저 벗는거라고? 왜 그렇게 생각해?<br/><br/>모든 사람의 페르소나를 'Show'로 표현하고자 오페라 '카르멘'의 아리아 '하바네라'의 멜로디를 차용한 얼터너티브 팝 장르의 곡으로, 꾸며지지 않은 개인의 본모습을 누드라는 단어에 빗대어 표현하였으며 단어에 대한 외설스러운 시선을 대범하게 비꼬는 가사가 인상적이다. 셔플 리듬의 풍부한 베이스 라인과 직설적인 가사가 어우러져 이목을 집중시키는 것이 한순간도 눈을 뗄 수 없는 뮤지컬 넘버 같기도 한 곡이다.",
        date: "2022.10.17",
    ...
    },
    {
        ...
        tit: "1st Single Album :<br/>DUMDi DUMDi",
        mtit: "DUMDi DUMDi",
        desc: "무더위를 이겨내는 우리만의 특별한 서머 송!<br/>여자아이들 1st 싱글 앨범 '덤디덤디(DUMDi DUMDi)'<br/><br/>‘덤디덤디 (DUMDi DUMDi)’는 트로피컬 기반에 뭄바톤 리듬이 더해져 여자아이들만의 특별한 여름을 느낄 수 있는 댄스 곡이다. 리더 소연과 작곡가 Pop Time이 함께 작업한 곡으로, 여름과 젊음에서 연상되는 ‘뜨거움', '시원함', '열정', '설렘' 등 솔직하고 직관적인 가사와 중독성 있는 멜로디가 어우러져 무더위를 이겨낼 여자아이들 표 서머 송이 탄생했다. 특히 이번 싱글은 여자아이들의 본격적인 여름 컴백에 걸맞는 스타일리시하고 힙한 이미지 변신으로도 화제를 모았다. 작곡, 작사는 물론 비주얼 콘셉트 기획에도 멤버들이 직접 참여하며 남다른 열정을 보였다. 사전 공개된 티저 이미지에서는 나홀로 휴가를 떠난 배우 미연, 자유를 누리는 방랑자 민니, 집콕 생활을 하는 수진, 오픈카를 타고 달리는 소연, 사막을 횡단하는 카우걸 우기, 쾌활한 아르바이트생 슈화의 모습이 담겨 있어 콘셉트에 대한 팬들의 궁금증을 배가시켰다.",
        date: "2020.08.26",
    ...
    },
    {
        ...
        tit: "1st Mini Album :<br/>LATATA",
        mtit: "LATATA",
        desc: "(여자)아이들 데뷔곡 \"LATATA\"!<br/>사랑에 빠져 이 밤을 불태우도록 신나게 춤을!<br/><br/>여자아이들의 당찬 포부가 담긴 이번 데뷔 앨범은 여자아이들의 아이(I)에 뜻을 담아 팀과 멤버들에 대해 소개하는 의미로 [I am]으로 지었다. 멤버 여섯 명의 환상적인 하모니는 앨범의 타이틀곡인 ‘LATATA’를 필두로 여섯 트랙으로 나누어 보여준다. 뭄바톤부터 발라드까지, 장르의 스펙트럼을 넘나들며 신인그룹에게서 찾아보기 힘든 완성도 높은 미니앨범 [I am]은 여자아이들의 무궁무진한 성장 가능성과 앞으로의 방향성을 기대해 볼 수 있다. 2018년 가요계를 뒤흔들 여자아이들을 주목해보자. 각자의 매력이 하나로 뭉쳐 그 누구도 쉽게 따라 할 수 없는 아이들만의 개성 있고 재미있는 아이덴티티를 정립하는 여정이 기대된다.",
        date: "2018.05.02",
